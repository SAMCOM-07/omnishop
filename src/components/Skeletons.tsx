...
export const SearchProductSkeleton = () => {
  return (
    <div className="animate-pulse bg-neutral-1 rounded-lg shadow-sm overflow-hidden relative w-full flex items-center gap-2">
      <div className="bg-neutral-3 w-12 h-12 aspect-square " />
      <div>
        {/* Title */}
        <div className="h-4 bg-neutral-3 rounded w-3/4" />
