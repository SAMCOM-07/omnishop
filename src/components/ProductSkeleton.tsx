const ProductSkeleton = () => {
  return (
    <div className="animate-pulse bg-white rounded-lg shadow-sm overflow-hidden relative w-full">
      {/* Image placeholder */}
      <div className="bg-neutral-2 aspect-square w-full" />

      <div className="p-3 space-y-2">
        {/* Title */}
        <div className="h-4 bg-neutral-2 rounded w-3/4" />

        {/* Price */}
        <div className="h-4 bg-neutral-2 rounded w-1/2" />

        {/* Button */}
        <div className="h-8 bg-neutral-2 rounded-md w-full mt-3" />
      </div>
